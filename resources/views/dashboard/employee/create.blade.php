...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{ adminUrl("employee/create") }}" enctype="multipart/form-data" method="post">
            @csrf
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control  {{ $errors->has('fname') ? 'is-invalid' : ''  }}" name="fname" id="" placeholder="Enter Employee Name" value="{{old('fname')}}">
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('lname') ? 'is-invalid' : ''  }}" name="lname" id="" placeholder="Enter Employee Last Name" value="{{old('lname')}}">
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="email" class="form-control {{ $errors->has('email') ? 'is-invalid' : ''  }}" name="email" id="" placeholder="Enter Employee Email" value="{{old('email')}}">
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="password" class="form-control {{ $errors->has('password') ? 'is-invalid' : ''  }}" name="password" id="" placeholder="Enter Employee Password" value="{{old('password')}}">
                                    <p class="help-block" >
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control {{ $errors->has('phone') ? 'is-invalid' : ''  }}" name="phone" id="" placeholder="Enter Employee Phone" value="{{old('phone')}}">
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="number" class="form-control {{ $errors->has('salary') ? 'is-invalid' : ''  }}" name="salary" id="" placeholder="Enter Employee Salary" value="{{old('salary')}}">
                                    <p class="help-block" >
