...
@section('content')
    ...
    <section class="content">
        ...
        <form role="form" action="{{ adminUrl("task/create") }}" method="post">
            @csrf
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Task Info</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="form-control  {{ $errors->has('title') ? 'is-invalid' : ''  }}" name="title" id="" placeholder="Enter Task Title" value="{{old('title')}}">
                                    <p class="help-block" >
                                        Enter Title of Task
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="description" id="" class="form-control  {{ $errors->has('description') ? 'is-invalid' : ''  }}" rows="10" placeholder="Enter Task Description">{{old('description')}}</textarea>
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="datetime-local" class="form-control  {{ $errors->has('start_at') ? 'is-invalid' : ''  }}" name="start_at" id="" placeholder="Enter Task Start At" value="{{old('start_at')}}">
                                    <p class="help-block" >
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="datetime-local" class="form-control  {{ $errors->has('end_at') ? 'is-invalid' : ''  }}" name="end_at" id="" placeholder="Enter Task End At" value="{{old('end_at')}}">
                                    <p class="help-block" >
